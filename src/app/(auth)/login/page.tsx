      ...
      <div className="w-full max-w-sm border border-border bg-card p-6 md:p-8">
        <div className="mb-8 text-center sm:text-left">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Access your money tracker ledger.
          </p>
        </div>
        ...
        <div className="mt-6 text-center text-xs text-muted-foreground">
          ...
          <Link href="/signup" className="font-semibold text-foreground underline decoration-1 underline-offset-4 hover:text-muted-foreground transition-all">
            Sign Up
          </Link>
        </div>
      </div>
